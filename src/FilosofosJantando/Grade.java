...
public class Grade extends JPanel implements Runnable
{
    ...
    static Filosofos filosofo[] = new Filosofos[5];
    ...
    public void init ()
    {
        ...
        filosofo[0] = new Filosofos("Platao", 0);
        filosofo[1] = new Filosofos("Socrates", 1);
        filosofo[2] = new Filosofos("Aristoteles", 2);
        filosofo[3] = new Filosofos("Tales", 3);
        filosofo[4] = new Filosofos("Sofocles", 4);
